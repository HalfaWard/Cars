...
namespace Game.Track
{
    public class TrackState : GameState
    {
        ...
        private int[] outerX = {1700, 1825, 1900, 1900, 1825, 1700, 0300, 0175, 0100, 0100, 0175, 0300};
        private int[] outerY = {0100, 0175, 0300, 0900, 1025, 1100, 1100, 1025, 0900, 0300, 0175, 0100};
        
        private int[] innerX = {1500, 1625, 1700, 1700, 1625, 1500, 0500, 0375, 0300, 0300, 0375, 0500};
        private int[] innerY = {0300, 0375, 0500, 0700, 0825, 0900, 0900, 0825, 0700, 0500, 0375, 0300};
