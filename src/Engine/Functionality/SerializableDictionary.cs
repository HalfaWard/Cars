...
namespace Engine.Functionality
{
    ...
    public class SerializableDictionary<TKey, TValue> : Dictionary<TKey, TValue>, IXmlSerializable
    {
        ...
        public static XmlSerializer tempValueSerializer;
        ...
        private TValue ReadValue(XmlReader reader)
        {
            ...
            try
            {
                if (tempValueSerializer != null)
                    return (TValue)tempValueSerializer.Deserialize(reader);
        ...
        private void WriteValue(XmlWriter writer, TValue value)
        {
            ...
            {
                if(tempValueSerializer != null)
                    tempValueSerializer.Serialize(writer, value);
                else
